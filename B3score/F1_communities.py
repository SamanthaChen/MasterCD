...
class F1_communities(object):
    ...
    def __init__(self, community_filename, groundtruth_filename):
        ...
        self.gt_count = 0
        self.id_count = 0
        self.gt_nodes = {} #groundtruth节点
        self.id_nodes = {} #算法结果的节点
    ...
    def get_precision_recall(self):
        ...
        '打开groundTruth文件'
        f = open(self.ground_truth_filename) #打开groundTruth文件
        node_to_com = {}
        coms = {}

        # read ground truth 读文件
        cid = 0
        for l in f:
            cid += 1 #行数，社团id
            try:
        ...
        for l in f:
            ...
            for n in ns:
                ...
                try:
                    '在grount truth中的community'
                    # community in ground truth
                    idd = node_to_com[n] #节点的社团标号
                    if idd not in ids:
                        ids[idd] = 1
                    else:
                        ids[idd] += 1
